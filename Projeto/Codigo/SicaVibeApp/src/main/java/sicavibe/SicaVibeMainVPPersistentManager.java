...
public class SicaVibeMainVPPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "SicaVibeMainVP";
	...
	private SicaVibeMainVPPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new SicaVibeMainVPPersistentManager();
		}
